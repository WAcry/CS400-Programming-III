...
public class Graph implements GraphADT {
  ...
  private static class Vertex {
    ...
    private String label; // vertex content
    private ArrayList<Edge> edges; // all edges connected with this vertex
  ...
  private static class Edge {
    ...
    private String src; // source of the edge
    private String tar; // target of the edge
